...
import tabian.com.zoobook.materialcamera.util.Degrees;
import tabian.com.zoobook.materialcamera.util.ImageUtil;
import tabian.com.zoobook.materialcamera.util.ManufacturerUtil;

import static tabian.com.zoobook.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_BACK;
import static tabian.com.zoobook.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static tabian.com.zoobook.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
import static tabian.com.zoobook.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_ALWAYS_ON;
import static tabian.com.zoobook.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_AUTO;
import static tabian.com.zoobook.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_OFF;
...
public class CameraFragment extends BaseCameraFragment implements View.OnClickListener {
  ...
  tabian.com.zoobook.materialcamera.internal.CameraPreview mPreviewView;
...
//      Log.d(TAG, "openCamera: height: " + height);
  ...
  private void createPreview() {
    ...
    if (mWindowSize == null) mWindowSize = new Point();
    activity.getWindowManager().getDefaultDisplay().getSize(mWindowSize);
    mPreviewView = new tabian.com.zoobook.materialcamera.internal.CameraPreview(getActivity(), mCamera);
    if (mPreviewFrame.getChildCount() > 0 && mPreviewFrame.getChildAt(0) instanceof tabian.com.zoobook.materialcamera.internal.CameraPreview)
